...
::mods_hookExactClass("skills/backgrounds/character_background", function (o){
	...
	o.buildAttributes = function( _tag = null, _attrs = null )
	{
		...
		local c = this.onChangeAttributes();
		b.ActionPoints = 9;
		b.Hitpoints = ::DEF.C.Stats.Base.Hitpoints;
		b.Bravery = ::DEF.C.Stats.Base.Bravery;
		b.Stamina = ::DEF.C.Stats.Base.Stamina;
		b.MeleeSkill = ::DEF.C.Stats.Base.MeleeSkill;
		b.MeleeDefense = ::DEF.C.Stats.Base.MeleeDefense;
		b.Initiative = ::DEF.C.Stats.Base.Initiative;
		
		b.RangedSkill = ::DEF.C.Stats.Base.RangedSkill;
		b.RangedDefense = ::DEF.C.Stats.Base.RangedDefense;
