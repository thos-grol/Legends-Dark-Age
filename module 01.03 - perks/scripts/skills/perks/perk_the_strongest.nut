...
this.perk_the_strongest <- this.inherit("scripts/skills/skill", {
	m = {
		BUFF = 1
	},
	function create()
	{
		this.m.ID = "perk.the_strongest";
		this.m.Name = ::Const.Strings.PerkName.TheStrongest;
		this.m.Description = ::Const.Strings.PerkDescription.TheStrongest;
		this.m.Icon = "ui/perks/the_strongest.png";
