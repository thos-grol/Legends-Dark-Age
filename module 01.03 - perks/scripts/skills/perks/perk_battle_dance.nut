...
this.perk_battle_dance <- this.inherit("scripts/skills/skill", {
	m = {
		BUFF = 1
	},
	function create()
	{
		this.m.ID = "perk.battle_dance";
		this.m.Name = ::Const.Strings.PerkName.BattleDance;
		this.m.Description = ::Const.Strings.PerkDescription.BattleDance;
		this.m.Icon = "ui/perks/battle_dance.png";
